...
public class OCRDistortionTest extends
	...
	// Test
	public void testRotatedInputFile() {
		String inputImage = "jane_eyre_rotated.jpg";
		String expectedOutputPath = "jane_eyre.txt";
		OcrProperties properties = TestUtil.setProperties(2, 12, false);
	...
	// Test
	public void testInputFileWithHeader() {
		String inputImage = "jane_eyre_header.jpg";
		String expectedOutputPath = "jane_eyre.txt";
	...
	// Test
	public void testInputFileWithFooter() {
		String inputImage = "jane_eyre_footer.jpg";
		String expectedOutputPath = "jane_eyre.txt";
		OcrProperties properties = TestUtil.setProperties(2, 12, true);
	...
	// Test
	public void testBlurredInputFile() {
		String inputImage = "jane_eyre_blurred.jpg";
		String expectedOutputPath = "jane_eyre.txt";
		OcrProperties properties = TestUtil.setProperties(2, 12, false);
	...
	// Test
	public void testHalftoneInputFile() {
		String inputImage = "jane_eyre_halftone.jpg";
		String expectedOutputPath = "jane_eyre.txt";
		OcrProperties properties = TestUtil.setProperties(2, 12, false);
	...
	// Test
	public void testLightInputFile() {
		String inputImage = "jane_eyre_light.jpg";
		String expectedOutputPath = "jane_eyre.txt";
		OcrProperties properties = TestUtil.setProperties(2, 12, false);
	...
	// Test
	public void testDistoredInputFile() {
		String inputImage = "jane_eyre_wave.jpg";
		String expectedOutputPath = "jane_eyre.txt";
		OcrProperties properties = TestUtil.setProperties(2, 12, false);
